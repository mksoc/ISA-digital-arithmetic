...
Performing the synthesis at the maximum possible frequency with the architecture reported in figure \ref{fig:dfg}, we obtained the timing, area and power results shown in table \ref{tab:ret_res}. Notice that this time Design Compiler is not told which implementation to use for adders and multipliers. 
...
\begin{table}[hbtp]
	...
	\cline{1-2}
	Dynamic Power [\si{\micro\watt}{}]               & 4852                    &  &   \\ 
	\cline{1-2}
	Leakage Power [\si{\micro\watt}{}]               & 454.8                    &  &   \\ 
	\cline{1-2}
	\multicolumn{1}{l}{} & \multicolumn{1}{l}{} &  &  
	\end{tabular}
	\caption{Compile ultra synthesis results, optimized critical path}
...
\section{MBE based Multiplier with Roorda's approach and Dadda Tree}
	...
	\begin{figure}[H]
	  \centering
	  \subfloat[Max Absolute error]{\includegraphics[width=0.5\textwidth]{media/graphs/ApproxCompr-mult-MaxAbsError.jpg}\label{fig:f1}}
	  \hfill
	  \subfloat[Avg Absolute error]{\includegraphics[width=0.5\textwidth]{media/graphs/ApproxCompr-mult-AvgAbsError.jpg}\label{fig:f2}}
	  \caption{Absolute errors for multiplier architecture}
	\end{figure}

	\begin{figure}[H]
	  \centering
	  \subfloat[Max Relative error]{\includegraphics[width=0.5\textwidth]{media/graphs/ApproxCompr-mult-MaxRelError.jpg}\label{fig:f1}}
	  \hfill
	  \subfloat[Avg Relative error]{\includegraphics[width=0.5\textwidth]{media/graphs/ApproxCompr-mult-AvgRelError.jpg}\label{fig:f2}}
	...
	\begin{figure}[H]
		\centering
		\subfloat[Area]{\includegraphics[width=0.5\textwidth]{media/graphs/ApproxCompr-mult-area.jpg}\label{fig:f1}}
		\hfill
		\subfloat[Arrival time of crithica path]{\includegraphics[width=0.5\textwidth]{media/graphs/ApproxCompr-mult-timing.jpg}\label{fig:f2}}
	...
	\begin{figure}[H]
		\centering
		\subfloat[Max Absolute error]{\includegraphics[width=0.5\textwidth]{media/graphs/Trunc-mult-MaxAbsError.jpg}\label{fig:f1}}
		\hfill
		\subfloat[Avg Absolute error]{\includegraphics[width=0.5\textwidth]{media/graphs/Trunc-mult-AvgAbsError.jpg}\label{fig:f2}}
		\caption{Absolute errors for multiplier architecture}
	\end{figure}

	\begin{figure}[H]
		\centering
		\subfloat[Max Relative error]{\includegraphics[width=0.5\textwidth]{media/graphs/Trunc-mult-MaxRelError.jpg}\label{fig:f1}}
		\hfill
		\subfloat[Avg Relative error]{\includegraphics[width=0.5\textwidth]{media/graphs/Trunc-mult-AvgRelError.jpg}\label{fig:f2}}
		\caption{Relative errors for multiplier architecture}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\subfloat[Area]{\includegraphics[width=0.5\textwidth]{media/graphs/Trunc-mult-area.jpg}\label{fig:f1}}
		\hfill
		\subfloat[Arrival time of crithica path]{\includegraphics[width=0.5\textwidth]{media/graphs/Trunc-mult-timing.jpg}\label{fig:f2}}
		\caption{Reports after multiplier synthesis}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\subfloat[Max Absolute error]{\includegraphics[width=0.5\textwidth]{media/graphs/ApproxCompr-filter-MaxAbsError.jpg}\label{fig:f1}}
		\hfill
		\subfloat[Avg Absolute error]{\includegraphics[width=0.5\textwidth]{media/graphs/ApproxCompr-filter-AvgAbsError.jpg}\label{fig:f2}}
		\caption{Absolute errors for filter architecture}
	\end{figure}

	\begin{figure}[H]
		\centering
		\subfloat[Max Relative error]{\includegraphics[width=0.5\textwidth]{media/graphs/ApproxCompr-filter-MaxRelError.jpg}\label{fig:f1}}
		\hfill
		\subfloat[Avg Relative error]{\includegraphics[width=0.5\textwidth]{media/graphs/ApproxCompr-filter-AvgRelError.jpg}\label{fig:f2}}
	...
	\begin{figure}[H]
			\centering
			\subfloat[Max Absolute error]{\includegraphics[width=0.5\textwidth]{media/graphs/Trunc-filter-MaxAbsError.jpg}\label{fig:f1}}
			\hfill
			\subfloat[Avg Absolute error]{\includegraphics[width=0.5\textwidth]{media/graphs/Trunc-filter-AvgAbsError.jpg}\label{fig:f2}}
			\caption{Absolute errors for multiplier architecture}
		\end{figure}

		\begin{figure}[H]
			\centering
			\subfloat[Max Relative error]{\includegraphics[width=0.5\textwidth]{media/graphs/Trunc-filter-MaxRelError.jpg}\label{fig:f1}}
			\hfill
			\subfloat[Avg Relative error]{\includegraphics[width=0.5\textwidth]{media/graphs/Trunc-filter-AvgRelError.jpg}\label{fig:f2}}
			\caption{Relative errors for filter architecture}
		\end{figure}
	...
	\begin{figure}[H]
			\centering
			\subfloat[Area]{\includegraphics[width=0.5\textwidth]{media/graphs/ApproxCompr-filter-area.jpg}\label{fig:f1}}
			\hfill
			\subfloat[Arrival time of crithica path]{\includegraphics[width=0.5\textwidth]{media/graphs/ApproxCompr-filter-timing.jpg}\label{fig:f2}}
	...
	\begin{figure}[H]
			\centering
			\subfloat[Area]{\includegraphics[width=0.5\textwidth]{media/graphs/Trunc-filter-area.jpg}\label{fig:f1}}
			\hfill
			\subfloat[Arrival time of crithica path]{\includegraphics[width=0.5\textwidth]{media/graphs/Trunc-filter-timing.jpg}\label{fig:f2}}
			\caption{Reports after filter synthesis}
		\end{figure}
