...
\section{MBE based Multiplier with Roorda's approach and Dadda Tree}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{|c|c|c|c|}
		\hline
		\textit{\textbf{\begin{tabular}[c]{@{}c@{}}Multiplier approx\\ compressor with\\ compile\_ultra\end{tabular}}} & \textit{\textbf{Area}} & \textit{\textbf{Delay}} & \textit{\textbf{Frequency}} \\ \hline
