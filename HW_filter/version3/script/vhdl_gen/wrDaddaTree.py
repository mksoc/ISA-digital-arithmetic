...
# MODULES
#----------------------------------------------
from treeBindings_VHDLgen import wr4To2ApproxCompressor, wrFA, wrHA, vhdlDaddaLevel, autoBind
...
for currentLevel in range(daddaLevels, 0, -1):
	...
	cmprsArr, faArr, haArr, nextNumElmArr = autoBind(numElmArr, daddaRows[nextLevel], s.mtxCols)
